...
IFontDisp = Font
__all__ = [ 'StdFont', 'IPicture', 'OLE_YSIZE_CONTAINER', 'Picture',
           'OLE_XSIZE_PIXELS', 'OLE_OPTEXCLUSIVE',
           'OLE_XSIZE_HIMETRIC', 'OLE_YSIZE_HIMETRIC',
           'OLE_YPOS_PIXELS', 'OLE_YSIZE_PIXELS',
           'OLE_ENABLEDEFAULTBOOL', 'FontEvents', 'FONTSIZE',
           'IFontDisp', 'OLE_CANCELBOOL', 'IPictureDisp', 'VgaColor',
           'Default', 'OLE_XPOS_CONTAINER', 'Monochrome',
           'OLE_TRISTATE', 'FONTSTRIKETHROUGH', 'FONTITALIC',
           'FONTUNDERSCORE', 'OLE_YPOS_HIMETRIC', 'Color',
           'OLE_HANDLE', 'OLE_YPOS_CONTAINER', 'IFont',
           'OLE_XPOS_PIXELS', 'OLE_XPOS_HIMETRIC', 'StdPicture',
           'Checked', 'FONTNAME', 'LoadPictureConstants', 'OLE_COLOR',
           'FONTBOLD', 'Font', 'OLE_XSIZE_CONTAINER', 'Unchecked',
